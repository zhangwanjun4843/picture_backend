...
import com.example.picture.manager.FilePictureUpload;
import com.example.picture.manager.UrlPictureUpload;
...
import com.example.picture.model.entity.*;
...
// 开启事务
    ...
    public void doPictureReview(PictureReviewRequest pictureReviewRequest, User loginUser) {
        ...
        PictureReviewStatusEnum reviewStatusEnum = PictureReviewStatusEnum.getByValue(reviewStatus);
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        // 要抓取的地址
        String encodedSearchText = encode(searchText, "UTF-8");
        String fetchUrl = String.format("https://www.bing.com/images/search?q=%s", encodedSearchText);
        Document document;
        try {
        ...
        for (Element imgElement : imgElementList) {
            ...
            Map<String, String> mMap = JSONUtil.toBean(m_attr, HashMap.class);
